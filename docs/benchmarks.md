...
| 第 3 世代 | 31.94 → **31.74** | 第 2 世代 | 1600 | 50.1% (47.6..52.5) | +0.16 | 棄却 |

**第 3 世代は棄却した。** MSE は確かに 0.20 下がっているが、勝率は五分。
同じ 1600 局・同じ手順で第 2 世代の 0.70 の改善は 53.5% と有意に出ている
ので、**検出力が足りなかったのではなく差が無い**。学習データに対する
当てはまりの改善が、探索を通した指し手の差にはもう変換されない帯に入って
いる。重みは `weights/exp/20260816-nnue-sft/` に残してある。

...
FFO テスト 71 問 (fforum-1〜71、空きマス 6〜34、値は全問正解)。Edax は
公開版 4.5.5 を既定設定 (`-h 21`)、当方は既定の 2^26 表で走らせた。
どちらも単一スレッド (Edax は macOS では Rosetta 経由の x86 バイナリ)。
fforum-72 以降は両者とも未計測。

スイート別の総計:

| スイート | 問数 | 当方ノード | Edaxノード | N比 | 当方秒 | Edax秒 | t比 | 当方NPS | EdaxNPS | ノード勝 |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| FFO 1-19  | 19 | 2.1M | 2.1M | 0.98 | 1.0 | 0.2 | — | 2.2M | 12.3M | 10/19 |
| FFO 20-39 | 20 | 105.1M | 111.3M | 0.94 | 9.8 | 9.3 | 1.06 | 10.7M | 12.0M | 11/20 |
| FFO 40-59 | 20 | 14,218M | 25,883M | **0.55** | 1,846 | 2,151 | **0.86** | 7.7M | 12.0M | 19/20 |
| FFO 60-71 | 12 | 24,910M | 62,372M | **0.40** | 4,697 | 6,052 | **0.78** | 5.3M | 10.3M | **12/12** |
| **総計** | **71** | **39,235M** | **88,368M** | **0.44** | **6,553** | **8,212** | **0.80** | **6.0M** | **10.8M** | **52/71** |

深い終盤ほど差が開く。最難関の FFO60-71 は**全問で Edax のノード数を
下回り** (0.40 倍)、時間でも 0.78 倍。逆に浅い FFO1-19 はノードでほぼ
互角 (0.98)、時間比は絶対値が極小 (当方 1.0 秒 / Edax 0.2 秒) ゆえの
見かけで、ウォームアップパスの固定コストが相対的に目立つだけ。★ は
当方が Edax のノード数を下回った問題。

NPS の差 (当方 6.0M/秒 対 Edax 10.8M/秒) は、当方が 1 ノードあたりに
並べ替えの先読み評価を厚くかけてノード数を削っている分で、ノード比の
優位はこの NPS 差を吸収した上での結果である。以下は問題ごとの明細
(時間比・NPS の「—」は Edax 側が 0.005 秒未満に丸められ算出不能):

| FFO | 空 | 値 | 当方ノード | Edaxノード | N比 | 当方秒 | Edax秒 | t比 | 当方NPS | EdaxNPS |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 14 | +18 | 86,771 | 65,756 | 1.32 | 0.07 | 0.01 | 12.33 | 1.2M | 11.0M |
| 2 | 14 | +10 | 49,013 | 32,817 | 1.49 | 0.05 | 0.00 | — | 1.0M | — |
| 3 | 14 | +2 | 85,274 | 139,180 | 0.61 ★ | 0.05 | 0.01 | 4.36 | 1.8M | 12.7M |
| 4 | 14 | +0 | 39,099 | 38,119 | 1.03 | 0.05 | 0.00 | — | 0.8M | — |
...
| 9 | 15 | -8 | 40,787 | 66,677 | 0.61 ★ | 0.05 | 0.01 | 7.83 | 0.9M | 11.1M |
| 10 | 15 | +10 | 89,096 | 117,384 | 0.76 ★ | 0.05 | 0.01 | 4.45 | 1.8M | 10.7M |
| 11 | 15 | +30 | 96,852 | 69,315 | 1.40 | 0.05 | 0.01 | 8.17 | 2.0M | 11.6M |
| 12 | 15 | -8 | 103,241 | 103,976 | 0.99 ★ | 0.05 | 0.01 | 6.37 | 2.0M | 13.0M |
| 13 | 16 | +14 | 77,922 | 101,769 | 0.77 ★ | 0.05 | 0.01 | 4.90 | 1.6M | 10.2M |
| 14 | 16 | +18 | 96,518 | 100,291 | 0.96 ★ | 0.05 | 0.01 | 4.64 | 1.9M | 9.1M |
...
| 18 | 16 | -2 | 251,892 | 206,354 | 1.22 | 0.06 | 0.02 | 3.41 | 4.3M | 12.1M |
| 19 | 16 | +8 | 264,615 | 195,516 | 1.35 | 0.06 | 0.02 | 3.41 | 4.6M | 11.5M |
| 20 | 6 | +6 | 31 | 321 | 0.10 ★ | 0.07 | 0.00 | — | 0.0M | — |
| 21 | 15 | +0 | 226,890 | 241,565 | 0.94 ★ | 0.06 | 0.02 | 3.29 | 4.1M | 14.2M |
| 22 | 17 | +2 | 676,449 | 552,554 | 1.22 | 0.09 | 0.05 | 1.85 | 8.0M | 12.0M |
| 23 | 18 | +4 | 631,557 | 461,035 | 1.37 | 0.08 | 0.04 | 2.05 | 7.9M | 11.8M |
| 24 | 19 | +0 | 1,158,650 | 1,297,487 | 0.89 ★ | 0.11 | 0.10 | 1.02 | 10.9M | 12.5M |
| 25 | 19 | +0 | 2,959,133 | 4,376,341 | 0.68 ★ | 0.20 | 0.35 | 0.56 | 14.9M | 12.4M |
| 26 | 20 | +0 | 7,128,862 | 11,544,918 | 0.62 ★ | 0.58 | 0.92 | 0.64 | 12.2M | 12.6M |
| 27 | 20 | -2 | 2,019,572 | 1,746,121 | 1.16 | 0.26 | 0.15 | 1.72 | 7.9M | 11.7M |
| 28 | 20 | +0 | 6,699,645 | 9,677,264 | 0.69 ★ | 0.57 | 0.73 | 0.78 | 11.8M | 13.2M |
| 29 | 20 | +10 | 1,703,259 | 956,300 | 1.78 | 0.23 | 0.10 | 2.41 | 7.4M | 10.0M |
| 30 | 20 | +0 | 2,704,790 | 2,708,765 | 1.00 ★ | 0.30 | 0.23 | 1.34 | 9.0M | 12.0M |
| 31 | 20 | -2 | 2,184,394 | 2,020,088 | 1.08 | 0.27 | 0.17 | 1.55 | 8.2M | 11.7M |
| 32 | 20 | -4 | 5,930,481 | 5,544,293 | 1.07 | 0.45 | 0.43 | 1.04 | 13.1M | 12.8M |
| 33 | 20 | -8 | 10,390,607 | 4,740,142 | 2.19 | 0.72 | 0.41 | 1.74 | 14.4M | 11.4M |
| 34 | 20 | -2 | 5,974,634 | 8,056,286 | 0.74 ★ | 0.48 | 0.60 | 0.80 | 12.3M | 13.4M |
| 35 | 21 | +0 | 1,661,933 | 4,412,241 | 0.38 ★ | 0.31 | 0.37 | 0.83 | 5.3M | 11.8M |
| 36 | 21 | +0 | 10,209,131 | 8,065,703 | 1.27 | 0.86 | 0.66 | 1.32 | 11.8M | 12.3M |
| 37 | 22 | -20 | 26,914,328 | 21,199,050 | 1.27 | 2.02 | 1.94 | 1.04 | 13.4M | 10.9M |
| 38 | 24 | +4 | 15,679,562 | 23,359,013 | 0.67 ★ | 1.95 | 1.96 | 0.99 | 8.0M | 11.9M |
| 39 | 26 | +64 | 198,793 | 390,148 | 0.51 ★ | 0.19 | 0.04 | 4.62 | 1.0M | 9.3M |
| 40 | 20 | +38 | 8,136,620 | 10,878,154 | 0.75 ★ | 0.69 | 0.91 | 0.75 | 11.9M | 11.9M |
| 41 | 22 | +0 | 15,911,269 | 23,797,176 | 0.67 ★ | 1.31 | 1.94 | 0.68 | 12.1M | 12.3M |
| 42 | 22 | +6 | 18,951,133 | 26,821,290 | 0.71 ★ | 1.42 | 2.25 | 0.63 | 13.3M | 11.9M |
| 43 | 23 | -12 | 23,275,780 | 22,288,442 | 1.04 | 2.16 | 2.13 | 1.02 | 10.8M | 10.5M |
| 44 | 23 | -14 | 13,008,664 | 21,857,226 | 0.60 ★ | 1.41 | 2.01 | 0.70 | 9.2M | 10.9M |
| 45 | 24 | +6 | 185,756,584 | 268,624,047 | 0.69 ★ | 15.59 | 24.02 | 0.65 | 11.9M | 11.2M |
| 46 | 24 | -8 | 40,401,510 | 57,241,055 | 0.71 ★ | 3.92 | 4.85 | 0.81 | 10.3M | 11.8M |
| 47 | 25 | +4 | 14,456,559 | 15,931,040 | 0.91 ★ | 1.58 | 1.31 | 1.21 | 9.1M | 12.1M |
| 48 | 25 | +28 | 86,298,014 | 146,693,053 | 0.59 ★ | 12.26 | 13.63 | 0.90 | 7.0M | 10.8M |
| 49 | 26 | +16 | 134,937,133 | 296,432,537 | 0.46 ★ | 14.44 | 26.93 | 0.54 | 9.3M | 11.0M |
| 50 | 26 | +10 | 411,261,379 | 961,928,875 | 0.43 ★ | 72.31 | 91.04 | 0.79 | 5.7M | 10.6M |
| 51 | 27 | +6 | 148,234,582 | 262,947,565 | 0.56 ★ | 24.37 | 22.25 | 1.10 | 6.1M | 11.8M |
| 52 | 27 | +0 | 195,969,431 | 511,186,376 | 0.38 ★ | 19.93 | 43.28 | 0.46 | 9.8M | 11.8M |
| 53 | 28 | -2 | 1,812,516,896 | 2,722,945,536 | 0.67 ★ | 191.05 | 216.55 | 0.88 | 9.5M | 12.6M |
| 54 | 28 | -2 | 2,509,655,779 | 4,268,284,013 | 0.59 ★ | 200.48 | 329.41 | 0.61 | 12.5M | 13.0M |
| 55 | 29 | +0 | 6,493,037,870 | 11,814,236,791 | 0.55 ★ | 885.11 | 983.93 | 0.90 | 7.3M | 12.0M |
| 56 | 29 | +2 | 550,987,002 | 1,246,701,839 | 0.44 ★ | 100.27 | 108.13 | 0.93 | 5.5M | 11.5M |
| 57 | 30 | -10 | 962,352,130 | 1,378,480,983 | 0.70 ★ | 138.93 | 126.42 | 1.10 | 6.9M | 10.9M |
| 58 | 30 | +4 | 591,098,141 | 1,823,503,687 | 0.32 ★ | 158.07 | 149.30 | 1.06 | 3.7M | 12.2M |
| 59 | 34 | +64 | 1,815,547 | 1,869,527 | 0.97 ★ | 0.49 | 0.21 | 2.32 | 3.7M | 8.9M |
...
**並列化は意図的に未実装**。単一スレッドでのアルゴリズム的な効率を
追求する方針のため、次に大きく伸ばすとすればここになる。

SIMD (NEON) による反転計算は実装して計測したが**採用しなかった**。
8 方向を 2 レーンずつ並列化しても、スカラー版の「多くの方向は即座に
外れる」早期脱出と Apple Silicon の広いスカラー実行ポートに 3.7% 負ける
(等価性は 128 万局面 × 64 マスで検証済み)。

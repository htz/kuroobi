...
| 項目 | 内容 |
|---|---|
| CPU / RAM | Apple M1 Max (高性能 8 + 高効率 2 コア) / 64 GB |
| OS | macOS 26.5.1 |
| 当方 | Rust 1.92.0、arm64 ネイティブ、**単一スレッド**、`solve_obf --hash-bits 26` |
| Edax | 4.4.8 (`mEdax-x64-modern`、Rosetta 2 経由の x86-64)、**単一スレッド**、`-solve -level 60 -n 1 -h 26` |
| 置換表 | **両者ともエントリ数 2^26 に統一**。当方 32 B/エントリ 2-way (2.0 GB)、Edax 24 B/エントリ 4-way (1.5 GB) |

Edax の `-h N` はバケット数ではなくエントリ総数 2^N (`hash_init` が
"init hashtable of N entries" と報告する値) なので、両者に同じ 26 を
与えるとエントリ数が正確に一致する。Edax は Rosetta 2 上の x86-64 実行の
ため、ネイティブ x86 機で得られる Edax の NPS とは異なる点に注意。

> fforum-60〜71 の行のみ旧条件 (Edax は既定の `-h 21`、当方は同じ 2^26) で
> 計測したままで、この表の他の行とは Edax 側の置換表サイズが異なる。
> 総計行はその 12 問を含む。

総ノードは Edax の 0.44 倍、総時間は 0.79 倍。深い終盤ほど差が開き、
1 ノードあたりの速度 (NPS) は当方が約半分だが、これは並べ替えの先読み
評価を厚くかけてノード数を削っている分で、その NPS 差を吸収した上での
ノード・時間の優位である。

| FFO | 空 | 値 | 当方ノード | Edaxノード | N比 | 当方秒 | Edax秒 | t比 | 当方NPS | EdaxNPS |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 14 | +18 | 86,771 | 65,756 | 1.32 | 0.07 | 0.01 | 11.83 | 1.2M | 11.0M |
...
| 5 | 14 | +32 | 12,853 | 13,607 | 0.94 ★ | 0.05 | 0.00 | — | 0.3M | — |
| 6 | 14 | +14 | 83,714 | 62,292 | 1.34 | 0.05 | 0.01 | 8.17 | 1.7M | 10.4M |
| 7 | 14 | +8 | 31,334 | 22,684 | 1.38 | 0.05 | 0.00 | — | 0.7M | — |
| 8 | 15 | +8 | 288,025 | 253,321 | 1.14 | 0.06 | 0.02 | 2.95 | 5.1M | 13.3M |
| 9 | 15 | -8 | 40,787 | 66,677 | 0.61 ★ | 0.05 | 0.01 | 7.67 | 0.9M | 11.1M |
| 10 | 15 | +10 | 89,096 | 117,384 | 0.76 ★ | 0.05 | 0.01 | 4.80 | 1.9M | 11.7M |
| 11 | 15 | +30 | 96,852 | 69,315 | 1.40 | 0.05 | 0.01 | 8.00 | 2.0M | 11.6M |
| 12 | 15 | -8 | 103,241 | 103,976 | 0.99 ★ | 0.05 | 0.01 | 5.33 | 2.2M | 11.6M |
| 13 | 16 | +14 | 77,922 | 101,769 | 0.77 ★ | 0.05 | 0.01 | 5.44 | 1.6M | 11.3M |
| 14 | 16 | +18 | 96,518 | 100,291 | 0.96 ★ | 0.05 | 0.01 | 4.25 | 1.9M | 8.4M |
| 15 | 16 | +4 | 184,389 | 300,769 | 0.61 ★ | 0.05 | 0.03 | 2.04 | 3.5M | 11.6M |
| 16 | 16 | +24 | 197,528 | 215,695 | 0.92 ★ | 0.05 | 0.02 | 2.70 | 3.7M | 10.8M |
| 17 | 16 | +8 | 28,221 | 34,432 | 0.82 ★ | 0.05 | 0.00 | — | 0.6M | — |
| 18 | 16 | -2 | 251,892 | 206,354 | 1.22 | 0.06 | 0.02 | 3.29 | 4.5M | 12.1M |
| 19 | 16 | +8 | 264,615 | 195,516 | 1.35 | 0.06 | 0.02 | 3.29 | 4.7M | 11.5M |
| 20 | 6 | +6 | 31 | 321 | 0.10 ★ | 0.08 | 0.00 | — | 0.0M | — |
| 21 | 15 | +0 | 226,890 | 241,565 | 0.94 ★ | 0.05 | 0.02 | 2.89 | 4.4M | 13.4M |
| 22 | 17 | +2 | 676,449 | 552,554 | 1.22 | 0.08 | 0.05 | 1.62 | 8.7M | 11.5M |
| 23 | 18 | +4 | 626,954 | 461,035 | 1.36 | 0.08 | 0.04 | 1.90 | 8.0M | 11.2M |
| 24 | 19 | +0 | 1,158,808 | 1,297,487 | 0.89 ★ | 0.11 | 0.11 | 0.95 | 10.9M | 11.7M |
| 25 | 19 | +0 | 2,958,131 | 4,376,341 | 0.68 ★ | 0.19 | 0.38 | 0.50 | 15.7M | 11.6M |
| 26 | 20 | +0 | 7,112,934 | 11,544,918 | 0.62 ★ | 0.60 | 0.95 | 0.63 | 11.8M | 12.1M |
| 27 | 20 | -2 | 2,019,021 | 1,746,121 | 1.16 | 0.26 | 0.16 | 1.67 | 7.8M | 11.2M |
| 28 | 20 | +0 | 6,682,903 | 9,677,264 | 0.69 ★ | 0.54 | 0.78 | 0.70 | 12.3M | 12.5M |
| 29 | 20 | +10 | 1,702,598 | 956,300 | 1.78 | 0.23 | 0.10 | 2.28 | 7.5M | 9.6M |
| 30 | 20 | +0 | 2,715,745 | 2,708,765 | 1.00 | 0.33 | 0.23 | 1.39 | 8.4M | 11.6M |
| 31 | 20 | -2 | 2,182,796 | 2,020,088 | 1.08 | 0.26 | 0.19 | 1.40 | 8.4M | 10.9M |
| 32 | 20 | -4 | 5,930,126 | 5,544,293 | 1.07 | 0.45 | 0.46 | 0.98 | 13.2M | 12.1M |
| 33 | 20 | -8 | 10,312,160 | 4,740,142 | 2.18 | 0.70 | 0.43 | 1.64 | 14.7M | 11.1M |
| 34 | 20 | -2 | 5,916,114 | 8,056,286 | 0.73 ★ | 0.48 | 0.64 | 0.75 | 12.4M | 12.6M |
| 35 | 21 | +0 | 1,683,798 | 4,412,241 | 0.38 ★ | 0.30 | 0.38 | 0.79 | 5.5M | 11.5M |
| 36 | 21 | +0 | 10,204,078 | 8,065,703 | 1.27 | 0.84 | 0.68 | 1.23 | 12.1M | 11.8M |
| 37 | 22 | -20 | 26,794,835 | 21,198,649 | 1.26 | 1.95 | 2.08 | 0.94 | 13.7M | 10.2M |
| 38 | 24 | +4 | 15,643,089 | 23,307,707 | 0.67 ★ | 1.75 | 2.02 | 0.87 | 8.9M | 11.5M |
| 39 | 26 | +64 | 198,793 | 390,148 | 0.51 ★ | 0.20 | 0.04 | 4.88 | 1.0M | 9.3M |
| 40 | 20 | +38 | 8,157,900 | 10,878,154 | 0.75 ★ | 0.65 | 0.94 | 0.69 | 12.5M | 11.5M |
| 41 | 22 | +0 | 15,904,707 | 23,796,300 | 0.67 ★ | 1.23 | 1.94 | 0.63 | 13.0M | 12.3M |
| 42 | 22 | +6 | 18,876,035 | 26,813,245 | 0.70 ★ | 1.38 | 2.34 | 0.59 | 13.7M | 11.5M |
| 43 | 23 | -12 | 23,302,642 | 22,117,072 | 1.05 | 2.03 | 2.24 | 0.91 | 11.5M | 9.9M |
| 44 | 23 | -14 | 12,964,438 | 21,856,995 | 0.59 ★ | 1.30 | 2.08 | 0.63 | 9.9M | 10.5M |
| 45 | 24 | +6 | 185,251,988 | 270,780,654 | 0.68 ★ | 14.79 | 25.47 | 0.58 | 12.5M | 10.6M |
| 46 | 24 | -8 | 40,309,317 | 59,068,359 | 0.68 ★ | 3.59 | 5.29 | 0.68 | 11.2M | 11.2M |
| 47 | 25 | +4 | 14,430,026 | 15,930,973 | 0.91 ★ | 1.48 | 1.39 | 1.06 | 9.8M | 11.5M |
| 48 | 25 | +28 | 85,846,177 | 146,045,736 | 0.59 ★ | 11.35 | 14.39 | 0.79 | 7.6M | 10.1M |
| 49 | 26 | +16 | 135,621,193 | 311,844,723 | 0.43 ★ | 14.01 | 29.82 | 0.47 | 9.7M | 10.5M |
| 50 | 26 | +10 | 408,582,094 | 994,217,170 | 0.41 ★ | 66.97 | 100.16 | 0.67 | 6.1M | 9.9M |
| 51 | 27 | +6 | 147,657,567 | 266,920,468 | 0.55 ★ | 20.62 | 23.58 | 0.87 | 7.2M | 11.3M |
| 52 | 27 | +0 | 195,501,164 | 528,606,170 | 0.37 ★ | 18.94 | 47.42 | 0.40 | 10.3M | 11.1M |
| 53 | 28 | -2 | 1,807,682,264 | 2,667,161,830 | 0.68 ★ | 163.19 | 222.31 | 0.73 | 11.1M | 12.0M |
| 54 | 28 | -2 | 2,507,860,554 | 4,228,951,916 | 0.59 ★ | 192.69 | 340.12 | 0.57 | 13.0M | 12.4M |
| 55 | 29 | +0 | 6,488,196,919 | 11,261,031,910 | 0.58 ★ | 851.69 | 975.70 | 0.87 | 7.6M | 11.5M |
| 56 | 29 | +2 | 551,918,319 | 1,325,146,365 | 0.42 ★ | 92.45 | 116.89 | 0.79 | 6.0M | 11.3M |
| 57 | 30 | -10 | 958,044,578 | 1,243,905,723 | 0.77 ★ | 123.41 | 120.88 | 1.02 | 7.8M | 10.3M |
| 58 | 30 | +4 | 585,399,262 | 1,849,564,180 | 0.32 ★ | 144.13 | 157.70 | 0.91 | 4.1M | 11.7M |
| 59 | 34 | +64 | 1,815,481 | 1,869,527 | 0.97 ★ | 0.51 | 0.21 | 2.43 | 3.5M | 8.9M |
...
| **計** | | | **39,209,864,887** | **87,761,900,179** | **0.45** | **6433** | **8253** | **0.78** | **6.1M** | **10.6M** |

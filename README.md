...
> **この比較は Edax に不利であることに注意。** 手元の Edax は x86-64
> バイナリを Rosetta 2 で動かしており、変換のオーバーヘッドを負っている。
> Edax は AVX2/BMI2 (pext) の x86 専用経路に加え **NEON 経路も持つ**ので、
> arm64 ネイティブでビルドすれば下表よりかなり速いはずである。
> 参考として、公開されている
> [FFO ベンチマーク集計](https://t-ishii.la.coocan.jp/hp/mr/fforesult_155.html)
> では Edax 4.4 が Core i7-6700HQ (MacBook Pro 2016) の **1 スレッドで
> FFO40-59 を 1061 秒**で解いており、当方の同区間 1769 秒より速い。
> つまり *1 ノードあたりの速度では Edax が明確に上*で、当方はノード数を
> 減らすことでそれを補っている、というのが実態である。
...
|---:|---:|---:|---:|---:|
| 1 | 1780.5 秒 | 1.00× | 1769.4 秒 | 1.00× |
| 8 | 334.0 秒 | 5.33× | 327.9 秒 | 5.40× |
| **10** | **303.2 秒** | **5.87×** | **297.1 秒** | **5.96×** |

10 スレッド (物理コア数) が最良で、高効率コア 2 基を使う上積みが遅い
コアによる待ちを上回る。同じ集計ページの Edax 4.4 8 スレッド
(2016 MBP) が FFO40-59 を 241 秒なので、arm64 ネイティブ同士なら
まだ及ばないと見るのが妥当。
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 14 | +18 | 86,771 | 65,756 | 1.32 | 0.08 | 0.01 | 12.67 | 1.1M | 11.0M |
| 2 | 14 | +10 | 49,013 | 32,817 | 1.49 | 0.05 | 0.00 | — | 1.0M | — |
| 3 | 14 | +2 | 85,274 | 139,180 | 0.61 ★ | 0.05 | 0.01 | 4.27 | 1.8M | 12.7M |
| 4 | 14 | +0 | 39,099 | 38,119 | 1.03 | 0.04 | 0.00 | — | 0.9M | — |
| 5 | 14 | +32 | 12,853 | 13,607 | 0.94 ★ | 0.04 | 0.00 | — | 0.3M | — |
| 6 | 14 | +14 | 83,714 | 62,292 | 1.34 | 0.05 | 0.01 | 7.67 | 1.8M | 10.4M |
| 7 | 14 | +8 | 31,334 | 22,684 | 1.38 | 0.04 | 0.00 | — | 0.7M | — |
| 8 | 15 | +8 | 288,025 | 253,321 | 1.14 | 0.06 | 0.02 | 2.89 | 5.2M | 13.3M |
| 9 | 15 | -8 | 40,787 | 66,677 | 0.61 ★ | 0.05 | 0.01 | 7.67 | 0.9M | 11.1M |
| 10 | 15 | +10 | 89,096 | 117,384 | 0.76 ★ | 0.05 | 0.01 | 4.90 | 1.8M | 11.7M |
| 11 | 15 | +30 | 96,852 | 69,315 | 1.40 | 0.05 | 0.01 | 8.33 | 1.9M | 11.6M |
...
| 15 | 16 | +4 | 184,389 | 300,769 | 0.61 ★ | 0.05 | 0.03 | 2.00 | 3.5M | 11.6M |
| 16 | 16 | +24 | 197,528 | 215,695 | 0.92 ★ | 0.05 | 0.02 | 2.65 | 3.7M | 10.8M |
| 17 | 16 | +8 | 28,221 | 34,432 | 0.82 ★ | 0.05 | 0.00 | — | 0.6M | — |
| 18 | 16 | -2 | 251,892 | 206,354 | 1.22 | 0.06 | 0.02 | 3.24 | 4.6M | 12.1M |
| 19 | 16 | +8 | 264,615 | 195,516 | 1.35 | 0.05 | 0.02 | 3.18 | 4.9M | 11.5M |
| 20 | 6 | +6 | 31 | 321 | 0.10 ★ | 0.07 | 0.00 | — | 0.0M | — |
| 21 | 15 | +0 | 226,890 | 241,565 | 0.94 ★ | 0.05 | 0.02 | 3.00 | 4.2M | 13.4M |
| 22 | 17 | +2 | 676,449 | 552,554 | 1.22 | 0.08 | 0.05 | 1.65 | 8.6M | 11.5M |
| 23 | 18 | +4 | 626,954 | 461,035 | 1.36 | 0.08 | 0.04 | 1.85 | 8.2M | 11.2M |
| 24 | 19 | +0 | 1,158,808 | 1,297,487 | 0.89 ★ | 0.10 | 0.11 | 0.90 | 11.6M | 11.7M |
| 25 | 19 | +0 | 2,958,131 | 4,376,341 | 0.68 ★ | 0.20 | 0.38 | 0.52 | 15.2M | 11.6M |
| 26 | 20 | +0 | 7,112,934 | 11,544,918 | 0.62 ★ | 0.64 | 0.95 | 0.67 | 11.2M | 12.1M |
| 27 | 20 | -2 | 2,019,021 | 1,746,121 | 1.16 | 0.29 | 0.16 | 1.85 | 7.0M | 11.2M |
| 28 | 20 | +0 | 6,682,903 | 9,677,264 | 0.69 ★ | 0.58 | 0.78 | 0.75 | 11.4M | 12.5M |
| 29 | 20 | +10 | 1,702,598 | 956,300 | 1.78 | 0.25 | 0.10 | 2.50 | 6.8M | 9.6M |
| 30 | 20 | +0 | 2,715,745 | 2,708,765 | 1.00 | 0.35 | 0.23 | 1.52 | 7.6M | 11.6M |
| 31 | 20 | -2 | 2,182,796 | 2,020,088 | 1.08 | 0.29 | 0.19 | 1.59 | 7.4M | 10.9M |
| 32 | 20 | -4 | 5,930,126 | 5,544,293 | 1.07 | 0.48 | 0.46 | 1.05 | 12.4M | 12.1M |
| 33 | 20 | -8 | 10,312,160 | 4,740,142 | 2.18 | 0.72 | 0.43 | 1.70 | 14.2M | 11.1M |
| 34 | 20 | -2 | 5,916,114 | 8,056,286 | 0.73 ★ | 0.51 | 0.64 | 0.80 | 11.5M | 12.6M |
| 35 | 21 | +0 | 1,683,798 | 4,412,241 | 0.38 ★ | 0.34 | 0.38 | 0.90 | 4.9M | 11.5M |
| 36 | 21 | +0 | 10,204,078 | 8,065,703 | 1.27 | 0.91 | 0.68 | 1.33 | 11.3M | 11.8M |
| 37 | 22 | -20 | 26,794,835 | 21,198,649 | 1.26 | 2.10 | 2.08 | 1.01 | 12.8M | 10.2M |
| 38 | 24 | +4 | 15,643,089 | 23,307,707 | 0.67 ★ | 1.82 | 2.02 | 0.90 | 8.6M | 11.5M |
| 39 | 26 | +64 | 198,793 | 390,148 | 0.51 ★ | 0.23 | 0.04 | 5.50 | 0.9M | 9.3M |
| 40 | 20 | +38 | 8,157,900 | 10,878,154 | 0.75 ★ | 0.70 | 0.94 | 0.74 | 11.7M | 11.5M |
| 41 | 22 | +0 | 15,904,707 | 23,796,300 | 0.67 ★ | 1.28 | 1.94 | 0.66 | 12.5M | 12.3M |
| 42 | 22 | +6 | 18,876,035 | 26,813,245 | 0.70 ★ | 1.46 | 2.34 | 0.63 | 12.9M | 11.5M |
| 43 | 23 | -12 | 23,302,642 | 22,117,072 | 1.05 | 2.21 | 2.24 | 0.99 | 10.5M | 9.9M |
| 44 | 23 | -14 | 12,964,438 | 21,856,995 | 0.59 ★ | 1.37 | 2.08 | 0.66 | 9.4M | 10.5M |
| 45 | 24 | +6 | 185,251,988 | 270,780,654 | 0.68 ★ | 15.34 | 25.47 | 0.60 | 12.1M | 10.6M |
| 46 | 24 | -8 | 40,309,317 | 59,068,359 | 0.68 ★ | 3.73 | 5.29 | 0.70 | 10.8M | 11.2M |
| 47 | 25 | +4 | 14,430,026 | 15,930,973 | 0.91 ★ | 1.63 | 1.39 | 1.17 | 8.9M | 11.5M |
| 48 | 25 | +28 | 85,846,177 | 146,045,736 | 0.59 ★ | 11.84 | 14.39 | 0.82 | 7.2M | 10.1M |
| 49 | 26 | +16 | 135,621,193 | 311,844,723 | 0.43 ★ | 14.32 | 29.82 | 0.48 | 9.5M | 10.5M |
| 50 | 26 | +10 | 408,582,094 | 994,217,170 | 0.41 ★ | 69.39 | 100.16 | 0.69 | 5.9M | 9.9M |
| 51 | 27 | +6 | 147,657,567 | 266,920,468 | 0.55 ★ | 20.78 | 23.58 | 0.88 | 7.1M | 11.3M |
| 52 | 27 | +0 | 195,501,164 | 528,606,170 | 0.37 ★ | 19.66 | 47.42 | 0.41 | 9.9M | 11.1M |
| 53 | 28 | -2 | 1,807,682,264 | 2,667,161,830 | 0.68 ★ | 167.78 | 222.31 | 0.75 | 10.8M | 12.0M |
| 54 | 28 | -2 | 2,507,860,554 | 4,228,951,916 | 0.59 ★ | 199.92 | 340.12 | 0.59 | 12.5M | 12.4M |
| 55 | 29 | +0 | 6,488,196,919 | 11,261,031,910 | 0.58 ★ | 870.93 | 975.70 | 0.89 | 7.4M | 11.5M |
| 56 | 29 | +2 | 551,918,319 | 1,325,146,365 | 0.42 ★ | 94.43 | 116.89 | 0.81 | 5.8M | 11.3M |
| 57 | 30 | -10 | 958,044,578 | 1,243,905,723 | 0.77 ★ | 126.49 | 120.88 | 1.05 | 7.6M | 10.3M |
| 58 | 30 | +4 | 585,399,262 | 1,849,564,180 | 0.32 ★ | 145.63 | 157.70 | 0.92 | 4.0M | 11.7M |
| 59 | 34 | +64 | 1,815,481 | 1,869,527 | 0.97 ★ | 0.54 | 0.21 | 2.55 | 3.4M | 8.9M |
...
| **計** | | | **39,209,864,887** | **87,761,900,179** | **0.45** | **6477** | **8253** | **0.78** | **6.1M** | **10.6M** |
...
**1 ノードあたりの速度 (NPS) が最大の弱点**。当方の 6 M nodes/s に対し、
x86 ネイティブの Edax は AVX2 と BMI2 (pext) 専用経路を持ち、桁違いに
速い。ノード数を 0.45 倍に抑えることで補っているが、単一スレッドの
wall-clock では 2016 年のハードウェア上の Edax にも及ばない。

SIMD (NEON) による反転計算と、`count_last_flip` のテーブル化は
どちらも実装して計測したが**採用しなかった**:

- NEON 反転: 8 方向を 2 レーンずつ並列化しても、スカラー版の「多くの
  方向は即座に外れる」早期脱出と Apple Silicon の広いスカラー実行
  ポートに 3.7% 負ける (等価性は 128 万局面 × 64 マスで検証済み)
- `count_last_flip`: 反転マスクを作らず数え上げるテーブル方式。正しさは
  320 万ケースで `flippable` と一致することを確認したが、約 1% 遅い。
  満杯まで 1 マスの盤では `flippable` の早期脱出が数命令で終わるうえ、
  この手法の要である斜め方向のビット gather は pext のない arm64 では
  速く書けない (Edax が速いのは x86 の pext / SIMD を使うため)

次に大きく伸ばすなら、評価関数そのものの再設計 (パターン構成の見直し)
になる。教師あり学習はすでに頭打ちで、val MSE をこれ以上下げても棋力に
転化しないことが確認されている。
